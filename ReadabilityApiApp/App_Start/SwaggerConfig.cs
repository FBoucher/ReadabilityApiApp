...
using ReadabilityApiApp;

[assembly: PreApplicationStartMethod(typeof(SwaggerConfig), "Register")]

namespace ReadabilityApiApp
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "ReadabilityApiApp");
        ...
        {
            return string.Format(@"{0}\ReadabilityApiApp.XML", System.AppDomain.CurrentDomain.BaseDirectory);
        }
    }
